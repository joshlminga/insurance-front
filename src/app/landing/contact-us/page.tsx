...
import { Car, ChevronDown, Clock, Coffee, Mail, MapPin, Phone, ShieldAlert, Wifi } from 'lucide-react'
import Navbar from '../components/navbar'
           ...
           <Navbar />
            <main>
                ...
                <header className="max-w-4xl mx-auto text-center pt-16 pb-12 px-4">
                    {/* <span className="inline-block bg-[#F1F1F1] text-[#4A4A4A] text-xs font-medium px-2.5 py-1 rounded mb-4">
                        Contact & Location
                    </span> */}
                    <h1 className="text-4xl font-bold tracking-tight text-[#111111] mb-3">
                        Visit Our Office or Get in Touch
                ...
                <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 px-4 pb-24">
                    ...
                    <section className="lg:col-span-7 bg-white border border-[#EAEAEA] rounded-sm p-8 shadow-sm">
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="space-y-1.5">
                                <label htmlFor="contactTime" className="text-sm font-semibold text-[#111111]">Preferred Contact Time</label>
                                <div className="relative">
                                    <select
                                        id="contactTime"
                                        className="w-full text-sm border border-[#E4E4E7] rounded px-3 py-2 appearance-none bg-white text-[#71717A] focus:outline-none focus:ring-1 focus:ring-black"
                            ...
                            {/* <button
                                type="submit"
                                className="w-full bg-[#E3003B] hover:bg-[#C20032] text-white text-sm font-medium py-2.5 rounded transition-colors mt-2"
                            >
                                Send Message
                            </button> */}
                            <Button 
