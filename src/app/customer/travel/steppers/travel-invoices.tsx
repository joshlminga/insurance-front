...
import { InvoicePaymentFormValues } from '@/types/schema'
import { CustomerVerificationDetailsProps, SubmitResponse } from '@/types/types'
...
export const TravelInvoicesPage: React.FC<CustomerVerificationDetailsProps> = ({ goToNextStep, goToPrevStep }) => {
