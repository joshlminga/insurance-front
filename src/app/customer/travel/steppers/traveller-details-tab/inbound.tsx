...
import { InBoundDestinationSchema } from '@/types/form-schema'
import { InboundFormValues } from '@/types/schema'
import {
...
export const TravellerDstinationInboundDetails: React.FC = ({
    goToNextStep,
    goToPrevStep
}: CustomerVerificationDetailsProps) => {
    const form = useForm<InboundFormValues>({
        resolver: zodResolver(InBoundDestinationSchema),
        defaultValues: {
            travel_as: "",
            type_of_trip: "",
            country_of_depature: "",
    ...
    const submitMutation = UseApiMutation<SubmitResponse, InboundFormValues>({
        url: "",
